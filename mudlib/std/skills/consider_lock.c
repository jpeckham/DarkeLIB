/*
   Consider Lock skill coded by Duridian
   10/1/96
*/
...
void skill_func(object from, object at, string arg) {
  ...
  if((time() - (int)from->query_last_use("consider lock")) / MINUTE < 7) {
     message("info",
...
"to rest your eyes for a moment before examining another lock.",
  ...
  switch(skill_lev) {
     case 1..25: modifier = 6; break;
     case 26..50: modifier = 5; break;
     case 51..75: modifier = 3; break;
  ...
  switch(lock_quot) {
     case -100..0: desc = "a very difficult time"; break;
     case 1..3: desc = "a difficult time"; break;
     case 4..7: desc = "some trouble"; break;
     case 8..11: desc = "a bit of trouble"; break;
     case 12..15: desc = "not too much trouble"; break;
     case 16..18: desc = "a little trouble"; break;
     case 19..22: desc = "an easy time"; break;
     case 23..25: desc = "a very easy time"; break;
     case 26..1000: desc = "an extremely easy time"; break;
