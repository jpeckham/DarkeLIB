...
void create() {
    ::create();
    set_property("name","light of day");
    ...
    set_property("caster message","You summon the light of day.");
    set_property("target message","");
    set_property("observer message","$C summons the light of day.");
...
void info() {
message("help",
"This spell summons light to guide your way.  You may specify
how bright you "
