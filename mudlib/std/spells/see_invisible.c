...
void create() {
    ...
    set_property("name","see invisible");
    ...
    set_property("caster message","You cast see invisible on $T.");

    set_property("target message","$C casts see invisible on you");

    set_property("observer message","$C casts see invisible on $T.");
...
void expire_me(object me) {
  ...
  message("info", "%^CYAN%^See invisible wears off.", me);
