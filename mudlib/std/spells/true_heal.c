...
void create() {
   ...
   set_property("base mp cost",10);
    ...
    set_property("caster message","You cast a TRUE healing spell upon $T.");
    set_property("target message","$C casts a TRUE healing spell upon you.");
    set_property("observer message","$C casts a TRUE healing spell upon $T.");
