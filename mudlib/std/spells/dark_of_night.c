...
void create() {
    ::create();
    set_property("name","dark of night");
    ...
    set_property("caster message","You summon the dark of night.");
    set_property("target message","");
    set_property("observer message","$C summons the dark of night.");
...
void info() {
message("help",
"This spell summons darkness that can blind most creatures.",
this_player());
}
