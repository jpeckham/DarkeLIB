...
*/
static Node
  *InitializeNode _FD((unsigned int,unsigned int,Node *,unsigned int,
    unsigned int,unsigned int));

static unsigned int
  DitherImage _FD((Image *));

static void
  ClosestColor _FD((Node *)),
  MColormap _FD((Node *)),
  PruneLevel _FD((Node *));

/*
  ...
  optimal;
{
  ...
  */
  ...
  image->colormap=(RGB *)
    malloc((unsigned int) cube.colors*sizeof(RGB));
  if (image->colormap == (RGB *) NULL)
    {
      (void) fprintf (stderr,
