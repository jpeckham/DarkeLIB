...
void create() {
   ...
   set("long",
   "You are standing in the southeastern corner of a huge chamber of the "
   ...
   "ground, and small rocks abound.  There is an exit to the southeast "
   ...
   set_exits( ([
                "northwest": PATH+"catac022",
                "west": PATH+"catac023",
                "southeast": PATH+"catac028",
                "north": PATH+"catac020",
                ]) );
}
