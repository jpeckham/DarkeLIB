...
void create() {
   ...
   "the south you see the tents of the kobold families.  Wilderness lies "
   "to the west of here."
   );
   set("night long",
   ...
   "kobolds.  Wilderness lies to the west of here."
   );
...
void reset() {
   if(!present("kobold farmer"))
      new(MON_PATH+"farmer")->move(this_object());
}
