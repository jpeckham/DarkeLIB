...
void create() {
   ...
   set("day long",
   "You are standing in the northwestern part of a circle of small tents.  "
   ...
   "particularly strong-looking kobolds to the east."
   );
   set("night long",
   ...
   "strong-looking kobolds to the east."
   );
