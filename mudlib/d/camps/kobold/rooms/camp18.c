...
void create() {
   ...
   "the south you see the tents of the kobold families.  To the southeast "
   "you see the trail that leads through the kobold campgounds.",
   );
   set("night long",
   ...
   "kobolds.  To the southeast you see the trail that leads through the "
   "kobold campgrounds."
   );
   ...
   set_exits( ([
                "west": PATH+"camp22",
                "southwest": PATH+"camp19",
                "southeast": PATH+"trail05",
                ]) );
}
