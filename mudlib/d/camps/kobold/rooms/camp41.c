...
void create() {
   ...
   "The mud is quite deep here, on the edge of this section of the "
   "campgrounds."
   );
   set("night long",
   ...
   "cooking meat, and it is sometimes difficult to see through the smoke.  "
   "The mud is quite deep here, on the edge of this section of the "
   "campgrounds."
   );
   ...
   set_items( ([
                "mud":
           "The deep mud is black and thick.",
                "tents":
