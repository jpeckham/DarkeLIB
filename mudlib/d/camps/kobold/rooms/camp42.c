...
void create() {
   ...
   "that such a small community would desire such heavy protection.  There "
   "is a little mud here on the ground."
   );
   set("night long",
   ...
   set_items( ([
                "mud":
           "There is just enough mud here to soil your boots.",
                "tents":
