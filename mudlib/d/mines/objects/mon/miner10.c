...
create() {
   ...
   set_short("An old dwarf Miner");
   set_level(20);
   set("long", "This is an experienced miner. You can see from his "
   "scars that the lifetime of work has been hard on him.");
   set_gender("male");
   set("race", "dwarf");
   set_max_hp(2500);
   set_hp(2500);
   ...
   set_overall_ac(25);
   set_emotes(5,
     ({ "The Miner scratches his beard.",
     "The Miner glances at the passage.",
     "The Miner examines a gem.",}),0 );
    set_achats(50,
