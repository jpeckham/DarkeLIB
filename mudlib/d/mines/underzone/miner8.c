...
create() {
   ...
   set("long", "This Miner has huge muscles under his work clothes. "
       "You can see them stretch and expand as he effortlessly picks up "
       "large rocks.");
   set_gender("male");
   set("race", "dwarf");
   set_exp(400000);
   ...
   set_emotes(5,
     ...
     "The Miner glances at a large rock and grins.",
     "The Miner flexes his arm muscle.",}),0 );
    set_achats(50,
    ({ "The Miner sidesteps your blow.",
     "The Miner grunts.",
