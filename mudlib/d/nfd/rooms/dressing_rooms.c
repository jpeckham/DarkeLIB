...
void reset() {
	...
	set_open("door",0);
	set_locked("door",1);
	"/d/nfd/rooms/dressing_room"->set_open("door",0);
	"/d/nfd/rooms/dressing_room"->set_locked("door",1);
}
...
void create() {
	...
	set_exits( (["east":"/d/nfd/rooms/manager_office",
		"west":"/d/nfd/rooms/dressing_room",
		"south":"/d/nfd/rooms/backstage" ]) );
	set_door("door","/d/nfd/rooms/dressing_room","west",
		"star key");
...
int open_door() {
	if ("/d/nfd/rooms/dressing_room"->actoress_home() ) {
