...
void reset() {
	set_open("door",0);
	set_locked("door",1);
	"/d/nfd/rooms/jail/prison1"->set_open("door",0);
	"/d/nfd/rooms/jail/prison1"->set_locked("door",1);
}
...
void create() {
	...
	set_exits((["southwest":"/d/nfd/rooms/level2",
		"north":"/d/nfd/rooms/jail/prison1"]));
	set_door("door","/d/nfd/rooms/prison_ent","north","jail keys");
