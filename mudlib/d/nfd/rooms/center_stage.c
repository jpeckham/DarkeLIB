...
"Hopefully you aren't naked now, or people will think you are crazy. "+
	...
	set_exits( (["west":"/d/nfd/rooms/backstage_left",
		"down":"/d/nfd/rooms/backstage_under",
		"east":"/d/nfd/rooms/backstage_right"]) );
