...
void create() {
	...
	set_items(([({"vendor","flower vendor","tigerwolf","girl","tigerwolf girl"}):"This really is a sad sight. "+
		"An obviously poor and meager tigerwolf who set up the stand,for the "+
	...
	set_exits((["east":"/d/nfd/rooms/level3/road7",
		"west":"/d/nfd/rooms/level3/road5"]));
}
...
void offer_flowers() {
	...
	call_out("offer_flowers",random(10)+1);
}
