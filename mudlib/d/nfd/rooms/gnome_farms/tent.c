...
void reset() {
	...
	if(!present("gnome king"))
		new("/d/nfd/mon/gnome_king")->move(this_object());
	if(!present("greater gnome"))
		new("/d/nfd/mon/greater_gnome")->move(this_object());
}
...
void create() {
	...
	set_exits((["southeast":"/d/nfd/rooms/gnome_farms/farm4"]));
}
