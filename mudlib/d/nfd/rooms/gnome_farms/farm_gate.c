// /d/nfd/rooms/gnome_farm/farm_gate
...
void reset() {
	...
	if(!present("sword guard")) {
		new("/d/nfd/mon/sword_guard")->move(this_object());
	}
	if(!present("spear guard")) {
		new("/d/nfd/mon/spear_guard")->move(this_object());
	}
	set_open("gate",0);
	set_locked("gate",1);
	"/d/nfd/rooms/gnome_farms/farm1"->set_open("gate",0);
	"/d/nfd/rooms/gnome_farms/farm1"->set_locked("gate",1);
...
void create() {
	...
	set_exits( (["northwest":"/d/nfd/rooms/gnome_farms/alley2",
		"west":"/d/nfd/rooms/gnome_farms/farm1"]));
	set_door("gate","/d/nfd/rooms/gnome_farms/farm1",
		"west","farm key");
	reset();
