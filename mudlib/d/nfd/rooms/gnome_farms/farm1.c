...
void reset() {
	::reset();
	if(!present("gnome"))
		new("/d/nfd/mon/gnome")->move(this_object());
		set_open("gate",0);
	set_locked("gate",1);
	"/d/nfd/rooms/gnome_farms/farm_gate"->set_open("gate",0);
	"/d/nfd/rooms/gnome_farms/farm_gate"->set_locked("gate",1);
}
...
,
	...
	set_exits((["east":"/d/nfd/rooms/gnome_farms/farm_gate",
		"west":"/d/nfd/rooms/gnome_farms/farm2"]));
	set_door("gate","/d/nfd/rooms/gnome_farms/farm_gate",
		"east","farm key");
