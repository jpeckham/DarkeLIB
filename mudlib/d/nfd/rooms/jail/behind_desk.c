...
void reset() {
	...
	if(!present("police man")) {
		police_man = new("/d/nfd/mon/police_man");
		new("/d/nfd/obj/jail_keys")->move(police_man);
...
void create() {
	...
	set_exits((["south":"/d/nfd/rooms/jail/prison1",
		"escape":"/d/nfd/rooms/ledge"]));
