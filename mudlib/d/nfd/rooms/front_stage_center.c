// /d/nfd/rooms/front_stage_center
...
void create() {
	...
	set_exits( (["south":"/d/nfd/rooms/seats",
	"west":"/d/nfd/rooms/front_left_stage",
	"east":"/d/nfd/rooms/front_right_stage"]) );
}
...
void pelting_action( object who ) {
int    stuff;
	if (query_night()) {
if (present(who)) {
	stuff = random(5);
