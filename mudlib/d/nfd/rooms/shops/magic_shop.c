...
void reset() {
	::reset();
	if (!present("dippy")) new("/d/nfd/rooms/shops/dippy")->move(
		this_object() );
}
...
void create() {
	...
	set_exits( (["southwest":"/d/nfd/rooms/street2",
		"east":"/d/nfd/rooms/shops/dippy_storage" ]) );
	set_door( "door","/d/nfd/rooms/shops/dippy_storage",
		"east","geegee" );
