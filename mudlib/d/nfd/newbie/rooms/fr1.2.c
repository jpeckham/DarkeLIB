...
void create() {
	...
	set_exits((["portal":"/d/nfd/rooms/emporium/newbie",
		"northeast":"/d/nfd/newbie/rooms/fr2.1",
		"east":"/d/nfd/newbie/rooms/fr2.2",
		"southeast":"/d/nfd/newbie/rooms/fr2.3"]));
}
