...
void create() {
   ...
   set("id", ({"mephit"}) );
   set_level(lev);
   set("short", "a steam mephit");
   set("long", @LONG
This creature is grey in colour and constantly appear to ooze hot
water, leaving a trail of water behind them when they move.
LONG
);
   set("race", "devil");
   set_gender("neuter");
   ...
   set_body_type("devil");
  set_property("melee damage", ([ "fire" : 15, ]));
  set_speed(150);
  set_moving(1);
}
