...
void reset() {
    ...
    ::reset();
    if(m<6) {
      new("/wizards/khojem/nomad/mon/sand_tiger")->move(this_object());
    }
    if(m<3) new("/wizards/khojem/nomad/mon/sand_tiger")->move(this_object());
}
...
void create() {
    ...
    add_exit("/wizards/khojem/nomad/room/d1","north");
    add_exit("/wizards/khojem/nomad/room/d10","east");
    add_exit("/wizards/khojem/nomad/room/s1","southeast");
    add_exit("/wizards/khojem/nomad/room/d2","south");
...
int my_mob_filter(object mob) {
  if(base_name(mob) == "/wizards/khojem/nomad/mon/sand_tiger")  
    return 1;                                        
  return 0;
}                                      
