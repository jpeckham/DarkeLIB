...
"spells.  The stone walls are scorched from numerious fumbled spells.\n");
  //  "\n" important here, too.
  ...
  add_exit("/d/damned/guilds/arch-mage/meeting","down");
  add_exit("/d/damned/guilds/arch-mage/gm-room","up");
