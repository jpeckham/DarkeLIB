...
void create() {
    ...
    set("short", "Northwest Market Square");
    set("long", "You are in the northwest corner of a market square.  "+
    ...
    add_exit("md_nmksq","east");
    add_exit("md_wmksq","south");
