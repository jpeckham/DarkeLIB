...
void create() {
  ::create();
    ...
    set_short("A large stone fountain");
    set_long("This large fountain is carved out of white granite from the mountains that sorround Daybreak Ridge. Standing on top of the fountain is a statue of Duke Traer in a military uniform.");
