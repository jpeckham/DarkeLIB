...
void set_search_func(string item, string func) { 
    set_search(item, (: call_other, call_out, this_object(), func :));
}
...
void set_smell_func(string item, string func) {
    set_smell(item, (: call_other, call_out, this_object(), func :));
}
...
void set_listen_func(string item, string func) {
    set_listen(item, (: call_other, call_out, this_object(), func :));
}
