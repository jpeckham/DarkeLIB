...
void create() {
   ::create();
   set_name("don");
   set("id", ({"shopkeeper", "shop keeper", "don", "don juan", "juan"}));
   ...
   set("short","Don Juan, the owner of this weapon store");
   set("long",
"Don Juan is an old tinker who has decided to set up shop and help the newbies. "
"He looks very experienced and tough.");
   set_gender("male");
   set_body_type("human");
   set("race", "high-man");
...
"dwarvish",
   ...
   set("storage room",ROOMS+"wstores");
