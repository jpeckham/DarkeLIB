...
void create() {
	...
	set_long("Here you stand on the southeastern corner of the graveyard.  This part of the graveyard is haunted by immense gnarled trees, the trees have been here since the founding of Akkad, except now they are empy husks that contain the essence of nothing more that air.  The head stones here are covered with moss and all sorts of fungi.");
	set_items(([
	"tree" : "These trees are immensly old and forboding.",
	"graves" : "The head stones are covered with moss and fungi.",
	"moss" : "The moss is dark green and dingy.",
	"fungi" : "The fungi are strange looking, some looking almost bio-mechanical."
	]));
