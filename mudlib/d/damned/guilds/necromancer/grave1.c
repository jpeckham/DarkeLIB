...
void create() {
	...
	set_long("You stand in the graveyard of Akkad, somewhat in awe and somewhat in digust.  The graveyard contains hundreds upon hundreds of graves, each different and special in their own little way.  The grounds of the graveyard are unkept and rugged, with tall blades of grass protruding in every spot and rocks lifted and over-turned in every place.");
	set_items(([
	"headstone" : "You think to yourself, 'I might someday stafy here.'",
	"grave" : "These graves are unkept and disorganized.",
	"grass" : "The grass is tall and protective.",
	]));
	set_listen("default", "There isn't a sound to hear.");
	set_smell("default", "The air is stale and looming.");
	set_exits(({
	"/d/damned/guilds/necromancer/front_gate",
