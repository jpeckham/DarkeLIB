...
"The cozy cottage feel of the other rooms has given way to "
"all the coziness of a blacksmith shop.  The walls are made of "
"iron, as is almost everything else.  Scraps are piled all over "
"the place.  You notice a shop of sorts buried under a large "
"forge and blacksmithing tools, and a sign nailed to the wall.  "
"You feel an intense blast of heat from the north, and hear "
"the clanging of metal in that direction.  To the south is a "
"large, sturdy closed door.  To think they fit all this into "
"one small cottage!\n");
...
/*	({"element list","mineral list","list"}):
   ...
   "%^BLUE%^=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=%^RESET%^\n" 
*/
   "sign" : "The sign reads: 'say bruno, help' for assistance.\n"
   ]) );
