...
void create() {
  ...
  set_long(
	   "This is the storage room for the Magic Shop. Lots of "
  ...
  add_exit("/d/damned/akkad/ak_shop5", "east");
  set_door("wooden door", "/d/damned/akkad/ak_shop5", "east",
	   "ak shop6 store");
...
void reset() {
  ...
  bob = present("shopkeeper", 
		find_object_or_load("/d/damned/akkad/ak_shop5"));
  if(bob) {
